...
class InstantiationException extends RuntimeException implements InjectionException
{

    public static function classNotFound(string $className, string $aliasedFrom=null):InstantiationException
    {
    ...
    public static function classNotInstantiable(string $className, string $aliasedFrom=null): InstantiationException
    {
